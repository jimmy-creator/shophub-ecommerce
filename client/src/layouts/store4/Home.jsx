...
const fallbackIcons = {
  ...
  'Apparel': <Shirt size={20} strokeWidth={1.6} />,
  'Equipment': <Dumbbell size={20} strokeWidth={1.6} />,
  'Accessories': <ShoppingBag size={20} strokeWidth={1.6} />,
  'Brands': <Award size={20} strokeWidth={1.6} />,
  'New Arrivals': <Watch size={20} strokeWidth={1.6} />,
};
...
export default function Home() {
  ...
  const categoryList = (categories === null ? [] : categories.length > 0 ? categories : [
    { name: 'Footwear' }, { name: 'Apparel' }, { name: 'Equipment' },
    { name: 'Accessories' }, { name: 'Brands' }, { name: 'New Arrivals' },
  ]);
